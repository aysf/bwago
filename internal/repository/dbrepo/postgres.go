...
func (m *postgresDBRepo) SearchAvailabilityByDatesByRoomID(start, end time.Time, roomID int) (bool, error) {
	...
	// debug
	m.App.InfoLog.Printf("[PARAM SQL] start: %v, end: %v, room_id: %v\n", start, end, roomID)
	m.App.InfoLog.Println("[QUERY SQL]", query)

	err := m.DB.QueryRowContext(ctx, query, roomID, end, start).Scan(&numRows)
	if err != nil {
		return false, err
	}
	...
	m.App.InfoLog.Println("RESULT SQL:", numRows)
...
func (m *postgresDBRepo) GetRoomByID(id int) (models.Room, error) {
	...
	// debug
	m.App.InfoLog.Printf("[PARAM SQL] room_id: %v\n", id)
	m.App.InfoLog.Println("[QUERY SQL]", query)
...
func (m *postgresDBRepo) InsertBlockForRoom(id int, startDate time.Time) error {
	...
	query := /* sql */ ` 
		INSERT INTO room_restriction (start_date, end_date, room_id, restriction_id,
